...
export default function RightAside({contact, rigthAsideClassName}) {
  return (
    <div className={` ${rigthAsideClassName} bg-[#373d4c] h-screen flex flex-col items-center overflow-auto scrollbar-custom`}>
